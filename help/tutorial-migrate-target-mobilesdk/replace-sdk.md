...
Veel API&#39;s voor doelextensies hebben een equivalente aanpak met de extensie voor besluitvorming die in de onderstaande tabel wordt beschreven. Voor meer details over de [ functies ](https://developer.adobe.com/client-sdks/edge/adobe-journey-optimizer-decisioning/api-reference/), verwijs naar de API verwijzing.
