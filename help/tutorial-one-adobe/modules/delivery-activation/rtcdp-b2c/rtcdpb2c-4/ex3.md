---
title: Audience Activation naar Microsoft Azure Event Hub - Setup the Event Hub destination in Adobe Experience Platform
description: Audience Activation naar Microsoft Azure Event Hub - Setup the Event Hub destination in Adobe Experience Platform
kt: 5342
doc-type: tutorial
...
Om de bovengenoemde informatie in het Portaal van Azure te zoeken, navigeer aan [ https://portal.azure.com/#home ](https://portal.azure.com/#home). Controleer of je het juiste Azure-account gebruikt.

Klik **Alle Middelen** in uw portaal van Azure:
...
Op dit punt zou u alle waarden moeten geïdentificeerd hebben nodig om de bestemming van de Hub van de Gebeurtenis van Azure in Echte-tijd CDP van Adobe Experience Platform te bepalen.
...
Ga naar **Doelen**, dan gaan naar **Catalogus**. Selecteer **Opslag van de Wolk**, ga naar **de Hubs van de Gebeurtenis van Azure** en klik **Opstelling**.
...
Ga terug naar [ Real-Time CDP: Audience Activation aan de Hub van de Gebeurtenis van Microsoft Azure ](./segment-activation-microsoft-azure-eventhub.md){target="_blank"}
