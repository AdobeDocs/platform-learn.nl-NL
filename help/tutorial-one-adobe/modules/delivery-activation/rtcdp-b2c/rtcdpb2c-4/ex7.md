...
Om de lading te tonen die door Adobe Experience Platform in real time CDP naar onze Hub van de Gebeurtenis van Azure op publiekskwalificatie wordt verzonden, moeten wij onze eenvoudige de trekkerfunctie van de Hub van de Gebeurtenis van Azure beginnen. Deze functie zal eenvoudig &quot;stortplaats&quot;de nuttige lading aan de console in de Code van Visual Studio. Maar denk eraan dat deze functie op elke manier kan worden uitgebreid om met allerlei omgevingen te communiceren met behulp van specifieke API&#39;s en protocollen.
...
Om uw functie van Azure in de Code van Visual Studio te beginnen/tegen te houden/opnieuw te beginnen, verwijs naar de vorige oefening.
