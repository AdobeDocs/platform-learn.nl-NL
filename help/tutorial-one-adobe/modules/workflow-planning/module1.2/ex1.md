...
Noem uw omslag `--aepUserLdap-- - CitiSignal Fiber Campaign` en klik **creëren**.
...
Dan zie je deze popup weer. Op het onderzoeksgebied, ga `wm:document` in en selecteer dan de status van het gebied **Document**. Klik **Uitgezocht**.
...
Dan zie je deze popup weer. Op het onderzoeksgebied, ga `wm:document` in en selecteer dan de gebied **Naam van het Document**. Klik **Uitgezocht**.
...
Selecteer de map met de naam `--aepUserLdap-- - CitiSignal Fiber Campaign` . Klik **toewijzen**.
