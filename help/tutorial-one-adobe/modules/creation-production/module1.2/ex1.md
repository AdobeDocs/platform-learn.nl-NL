...
1. Vind deze variabelen door naar [ https://developer.adobe.com/console/projects ](https://developer.adobe.com/console/projects) te gaan en uw project van Adobe I/O te openen, dat `--aepUserLdap-- Firefly` wordt genoemd.
