...
![&#x200B; de Opslag van Azure &#x200B;](./../module1.1/images/az105.png)
...
U ziet nu dat er een nieuw PSD-bestand is gegenereerd en opgeslagen in uw Microsoft Azure-opslagaccount.
...
Voor het **dossier van de Input**, uitgezochte **Azure** voor **de opslag van het dossier van de Input** en zorg ervoor om de output van het vorige verzoek te selecteren, **Adobe Photoshop - pas PSD uit**, die u als dit kunt bepalen: ``{{XX.data[].`_links`.renditions[].href}}`` (vervang XX door het opeenvolgingsaantal van de vorige module Adobe Photoshop - pas PSD uit).
