...
- Verbind onze gegevensset BigQuery met Customer Journey Analytics (CJA)
...
Op de homepage van Customer Journey Analytics, ga naar **Verbindingen**.

Hier ziet u alle verschillende verbindingen tussen CJA en Platform. Deze verbindingen hebben hetzelfde doel als rapportsuites in Adobe Analytics. De gegevensverzameling is echter totaal anders. Alle gegevens komen uit de datasets van Adobe Experience Platform.
...
>[!NOTE]
>
>Als u enkel de **verbinding van Gegevens** creeerde en **mening van Gegevens** u een paar uren zou kunnen moeten wachten. CJA heeft enige tijd nodig om historische gegevens te herstellen wanneer er een grote hoeveelheid gegevensrecords is.
...
Zoals hierboven vermeld, **de lijsten van de Vrije vorm** geven u de vrijheid u diepe duikanalyse moet uitvoeren. U kunt bijvoorbeeld een andere Dimension kiezen om een bepaalde metrische waarde in de tabel op te splitsen.
...
Kies Dimension **Safari** en sleep en laat vallen het bovenop een Metrisch, bijvoorbeeld **Controles**. U zult dan dit zien:
...
## 1.2.5.3.2 Funnel- of falloutanalyse

De trechters zijn een groot mechanisme om de belangrijkste stappen in een klantenreis te begrijpen. Deze stappen kunnen ook afkomstig zijn van offline interacties (bijvoorbeeld vanuit het callcenter) en vervolgens kunt u ze combineren met digitale aanraakpunten in dezelfde funnel.
...
- Een segment maken vanaf elk punt van de funnel
- Zie Trend in om het even welk stadium in een Grafiek van de Lijn visualisatie


Laten we nog iets zien wat je kunt doen: Hoe gaat mijn klantenreis Funnel deze maand tegenover de vorige maand? Hoe zit het met mobiel versus desktop?

Onder u zult twee panelen creëren:

- Funnel-analyse (januari)
- Funnel-analyse (februari)

U zult zien dat wij een funnel over verschillende tijdsperiodes (Januari en Februari) verdelen door het Type van Apparaat vergelijken.

Dit soort analyse is niet mogelijk in de gebruikersinterface van Google Analytics of is zeer beperkt. Dus CJA voegt weer veel waarde toe aan de gegevens die Google Analytics heeft vastgelegd.
...
Stel als analist dat u wilt begrijpen wat er gebeurt met uw belangrijkste e-commerce funnel: Home > Intern zoeken > Productdetails > Afhandeling > Aanschaffen.

Laten we beginnen met het toevoegen van nieuwe stappen aan de funnel. Om dat te doen, open de **dimensie van de Naam van de 0&rbrace; Pagina.**
...
- Vergelijk funnel visueel met verschillende tijdsperiodes.
