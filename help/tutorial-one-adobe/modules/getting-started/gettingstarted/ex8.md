...
>[!IMPORTANT]
>
>Als u geen werknemer van Adobe bent, volg de instructies om Postman [&#x200B; te installeren 0&rbrace;. &#x200B;](./ex7.md){target="_blank"} De onderstaande instructies zijn alleen bedoeld voor werknemers van Adobe.
...
Klik op de juiste versie voor het besturingssysteem.
