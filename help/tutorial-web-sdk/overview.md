...
* Voor **Journey Optimizer**:
   * Voor de facultatieve **les 0} van de Campagne van het Web {, moet u toestemmingspunten aan** hebben, **[!UICONTROL Manage campaigns]**, en **[!UICONTROL Publish campaigns]**.**[!UICONTROL View campaigns report]**
  <!--
