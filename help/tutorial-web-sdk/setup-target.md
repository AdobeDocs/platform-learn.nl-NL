...
>[!NOTE]
>
>Dit leerprogramma gebruikt de [ website van de Luma ](https://luma.enablementadobe.com){target=_blank}, die een asynchrone implementatie van markeringen en het flikkeren matiging op zijn plaats heeft. Deze sectie is voor verwijzing om te begrijpen hoe de het flikkeren matiging met het Web SDK van het Platform werkt.
...
1. Navigeer aan de [ plaats van de Luminagedemo ](https://luma.enablementadobe.com)
