...
>[!NOTE]
>
>Dit leerprogramma gebruikt de [&#x200B; website van de Luma &#x200B;](https://newluma.enablementadobe.com){target=_blank}, die een asynchrone implementatie van markeringen en het flikkeren matiging op zijn plaats heeft. Deze sectie is voor verwijzing om te begrijpen hoe de het flikkeren matiging met het Web SDK van het Platform werkt.
...
1. Selecteer de knop **[!UICONTROL Edit pre-hiding style]**
   ...
   ![&#x200B; het doel pre-verbergende fragment voor synchrone implementaties &#x200B;](assets/target-flicker-sync.png)
...
1. De regel `all pages - adobeDataLayer push - send event - 50` openen
...
1. Werk de naam van de Activiteit bij, dan selecteer **[!UICONTROL Next]**.
...
1. Ga naar de [&#x200B; plaats van de de demo van de Luma &#x200B;](https://newluma.enablementadobe.com) en gebruik debugger om [&#x200B; het markeringsbezit op de plaats aan uw eigen ontwikkelingeigenschap &#x200B;](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tags-property) te schakelen
...
1. Voeg een voorwaarde toe om de regel tot de homepage van Luma (weg zonder vraagkoord evenaart `/` of `/index.html`) te beperken.
...
1. Plak de volgende code in het inhoudsvak om de call-to-action in de held te wijzigen:
...
1. De labelregel openen `product detail pages - adobeDataLayer push - set product details variables - 20`
...
1. Het object **[!UICONTROL target]** selecteren
1. `entity.id` instellen als het gegevenselement `Ecommerce Product Id`
1. `entity.name` instellen als het gegevenselement `Ecommerce Product Name`
1. `user.categoryId` instellen als het gegevenselement `Ecommerce Product Category`
1. Selecteren **[!UICONTROL Keep Changes]**
1. Selecteren **[!UICONTROL Save]**
...
1. De regel `all pages - adobeDataLayer push - send event - 50` openen
1. Selecteer de handeling `Adobe Experience Platform Web SDK - Send event`
1. Voeg het gegevenselement `Data Variable` toe aan het veld Gegevens als dit nog niet is toegevoegd
...
Op de plaats van de Luma, laadt de gegevenslaag snel en volledig bepaald alvorens de Send vraag van de Gebeurtenis brandt. Op deze manier kunnen we een enkele oproep doen om persoonlijke inhoud op te halen (bijvoorbeeld vanuit Adobe Target) en analysegegevens te verzenden (bijvoorbeeld naar Adobe Analytics).
...
De tweede aanroep is ook verantwoordelijk voor het rapporteren van alle weergaven van gepersonaliseerde inhoud en het vervangen van alle `decisioning.propositionDisplay` aanroepen.
...
1. Selecteren **[!UICONTROL Keep Changes]**
1. **[!UICONTROL Save]** de regel

   ![&#x200B; send_decisions_request_alone &#x200B;](assets/target-decision-request.png)

U kunt als volgt het verzoek Analytics-on-bottom maken:

1. Een nieuwe regel maken met de naam `all pages - window loaded - send event - 50`
1. Voeg een gebeurtenis aan de regel toe. Gebruik de **uitbreiding van de Kern** en het **[!UICONTROL Window Loaded]** gebeurtenistype
...
1. Hierdoor wordt het selectievakje **[!UICONTROL Include rendered propositions]** vergrendeld, zodat de weergavemeldingen in de wachtrij van het beslissingsverzoek worden verzonden.
1. Selecteren **[!UICONTROL Keep Changes]**
1. **[!UICONTROL Save]** de regel
1. Uw bibliotheek bijwerken en opnieuw samenstellen

![&#x200B; send_decisions_request_alone &#x200B;](assets/target-aa-request-guided.png)

>[!TIP]
>
>Als de gebeurtenis u een BeslissingsVoorstelling met ophaalt geen gebeurtenis van Adobe Analytics na het heeft **[!UICONTROL Use guided events]** ongecontroleerd verlaten. U moet alle opties handmatig selecteren, maar hiermee wordt de optie **[!UICONTROL Include rendered propositions]** samen met de aanvraag voor het ophalen ontgrendeld.
...
1. Navigeer aan de [&#x200B; plaats van de Luminagedemo &#x200B;](https://newluma.enablementadobe.com)
