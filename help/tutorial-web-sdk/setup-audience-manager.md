...
1. Open de [&#x200B; homepage van de Luma &#x200B;](https://newluma.enablementadobe.com) (in kaart gebracht aan uw markeringsbezit) en **Adobe Experience Platform Debugger** en vernieuw de pagina.
...
1. Open de [&#x200B; homepage van de de demoomplaats van de Luma &#x200B;](https://newluma.enablementadobe.com) met het in kaart gebracht aan uw markeringsbezit om voor uw pas gecreeerd segment te kwalificeren.
...
1. Selecteer het domein **`https://newluma.enablementadobe.com`** en bevestig dat uw cookie correct is geschreven in de lijst
