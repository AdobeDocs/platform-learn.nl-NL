...
Een eigenschap tag is een container voor alle JavaScript, regels en andere functies die vereist zijn om gegevens van een webpagina te verzamelen en naar verschillende locaties te verzenden.
...
1. Als **[!UICONTROL Name]**, ga `Luma Web SDK Tutorial` in (voeg uw naam aan het eind toe, als de veelvoudige mensen van uw bedrijf deze zelfstudie nemen)
...
1. Selecteer de extensie `Adobe Experience Platform Web SDK` zodat de zijbalk wordt geopend
...
Laat de meeste standaardinstellingen ongewijzigd en werk deze indien nodig later bij. Het enige wat u nu moet doen, is de extensie aan uw datastream koppelen. Dit voegt correcte datastream/config identiteitskaart aan de netwerkvraag toe die van browser wordt gemaakt, zodat worden de vraag verpletterd aan de correcte gegevensstroom wanneer zij in het Platform Edge Network aankomen:

1. Selecteer onder **[!UICONTROL Datastreams]** de invoermethode **[!UICONTROL Choose from list]**
1. Configureer de **[!UICONTROL Production Environment]** . (De andere markeringsmilieu&#39;s in het bezit zullen de productiemontages erven):
   1. Selecteer de sandbox waarin u het schema, de naamruimte en de gegevensstroom hebt gemaakt
   1. Selecteer de gegevensstroom die u eerder hebt gemaakt, `Luma Web SDK: Development Environment`
1. Selecteren **[!UICONTROL Save]**
