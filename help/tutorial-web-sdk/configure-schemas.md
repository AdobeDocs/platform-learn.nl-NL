...
>[!NOTE]
>
> Voor demonstratiedoeleinden, bouwen de oefeningen in deze les een voorbeeldschema om inhoud te vangen die en producten door klanten in de [&#x200B; worden bekeken demo website van de Luma &#x200B;](https://luma.enablementadobe.com) worden gekocht. Volg samen om dit voorbeeldschema tot stand te brengen om de mogelijkheden van de schemaredacteur te leren en u zal bereid zijn om een schema voor uw eigen zaken achteraf te bouwen.
...
In deze oefening, zult u een schema XDM gebruikend de geadviseerde groepen van het basislijngebied voor het vangen van de gegevens van de Webgebeurtenis over de [&#x200B; demo van de Luma website &#x200B;](https://luma.enablementadobe.com){target="_blank"} tot stand brengen:
