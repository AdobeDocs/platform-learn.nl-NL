---
title: Afronding en volgende stappen van de zelfstudie Web SDK
...
* Vastgelegde gebieden van een gegevenslaag, transformeerde hen aan XDM, en verzond hen naar Platform Edge Network.
* Vastgelegde toestemming en geverifieerde identiteiten.
* De Web SDK-implementatie is verbonden met de volgende Experience Cloud-toepassingen:
   * Adobe Experience Platform
   * Adobe Analytics
   * Adobe Audience Manager
   * Adobe Target
   * Adobe Journey Optimizer
* Door:sturen gegevens van Platform Edge Network aan een Webhaak met gebeurtenis door:sturen.
