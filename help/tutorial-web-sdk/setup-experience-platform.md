...
Aangezien u verkeer op de [&#x200B; Plaats van de Demo van de Luma &#x200B;](https://luma.enablementadobe.com) produceert die aan uw markeringsbezit wordt in kaart gebracht, bevolkt de gegevens de dataset in Experience Platform!
...
1. Open de [&#x200B; plaats van de Luminagedemo &#x200B;](https://luma.enablementadobe.com) en selecteer het [!UICONTROL Experience Platform Debugger] uitbreidingspictogram
