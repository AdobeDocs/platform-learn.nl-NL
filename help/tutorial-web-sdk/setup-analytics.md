...
1. Onder **[!UICONTROL path equals]** set `/` `OR` `/index.html` . Voor de Luma-demonstratiewebsite zorgt deze ervoor dat de regel alleen wordt geactiveerd op de homepage
...
1. Ga naar de [&#x200B; de demowebsite van de Luma &#x200B;](https://luma.enablementadobe.com){target="_blank"}
...
Boven u vormde een gegevensstroomopheffing voor de [&#x200B; homepage van de Luma &#x200B;](https://luma.enablementadobe.com).  Om deze configuratie te bevestigen
...
Ga naar een productpagina als [&#x200B; Livingston All-Purpose Tight productpagina &#x200B;](https://luma.enablementadobe.com/product.html?id=LLMP09).  Controleer of de weergaven van de inhoudspagina worden vastgelegd door Analytics.
...
1. Voeg [&#x200B; Marco Lichtgewicht Actieve Hoodie &#x200B;](https://luma.enablementadobe.com/product.html?id=LLMH13) aan de kar toe
1. Ga naar de [&#x200B; Pagina van het Kart &#x200B;](https://luma.enablementadobe.com/cart.html), controleer het Spoor van Edge voor
