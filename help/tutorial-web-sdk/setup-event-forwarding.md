...
1. Volg de stappen aan [ schakelaar de markeringsbibliotheek ](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property) op de [ plaats van de Demo van de Luma ](https://newluma.enablementadobe.com/category-men.html) aan het de markeringsbezit van SDK van het Web waaraan u uw gebeurtenis-door:sturen bezit in de datastream in kaart bracht.
