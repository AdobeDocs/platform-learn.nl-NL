...
1. Volg de stappen aan [&#x200B; schakelaar de markeringsbibliotheek &#x200B;](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property) op de [&#x200B; de demowebsite van de Luma &#x200B;](https://luma.enablementadobe.com/category-men.html) aan het de markeringsbezit van SDK van het Web waaraan u uw gebeurtenis-door:sturen bezit in de datastream in kaart bracht.
