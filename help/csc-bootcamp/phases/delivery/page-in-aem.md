...
- Ga naar de AEM auteur op [https://author-p71057-e991028.adobeaemcloud.com/](https://author-p71057-e991028.adobeaemcloud.com/) en meld u aan met de gegevens die we hebben verstrekt.

- Selecteer Navigatie \> Sites in het menu AEM Start

![het pictogram Sites selecteren](./images/delivery-web-aem-sites.png)
...
![de inhoud van het bootkamp terugvinden](./images/delivery-web-create-page.png)
...
![selecteer de juiste sjabloon](./images/delivery-web-create-page-template.png)
...
![eigenschappen invullen](./images/delivery-web-create-page-properties.png)
...
![De nieuwe pagina openen](./images/delivery-web-create-page-success.png)
...
- Selecteer in het menu AEM Start de optie Navigatie \> Fragmenten voor ervaring

![Selecteer het XF-pictogram](./images/delivery-web-xf.png)
...
![een map maken](./images/delivery-web-create-xf-folder.png)
...
![een naam geven](./images/delivery-web-create-xf-folder-name.png)

- De map moet nu worden weergegeven. Klik erop en klik vervolgens op de knop Maken \> Experience Fragment.

![een xf maken](./images/delivery-web-create-xf.png)
...
![een xf-sjabloon selecteren](./images/delivery-web-create-xf-template.png)

- Geef uw ervaringsfragment een betekenisvolle titel, bijvoorbeeld &quot;Adobe USPs&quot;, dan klik creeer knoop.

![de xf een titel geven](./images/create-xf-properties.png)
...
![de xf-editor](./images/delivery-web-xf-editor.png)
...
![een component kopiëren](./images/delivery-web-copy-from-home.png)

- Klik vervolgens weer in het ervaringsfragment op de lay-outcontainer en klik op de knop Plakken.

![de component plakken](./images/delivery-web-paste-to-xf.png)

>[!NOTE]
>
> Tip: Met AEM kunt u de &quot;lay-outmodus&quot; in elke pagina gebruiken of een fragment ervaren. Op deze manier kunt u het formaat van de componenten aanpassen en de ervaringen voor elk apparaat optimaliseren.

- Open in het bovenste menu het vervolgkeuzemenu en selecteer Lay-out om de lay-outmodus te activeren.

![wijzigen in de lay-outmodus](./images/delivery-web-layout-mode.png)
...
![de grootte van componenten aanpassen aan uw wensen](./images/delivery-web-layout-resize.png)
...
![een onderbrekingspunt selecteren](./images/delivery-web-bp-before.png)
...
![een xf-component slepen en neerzetten](./images/delivery-web-xf-on-home.png)
...
![klik op het mappictogram](./images/delivery-web-xf-dialog.png)

![Selecteer de juiste XF](./images/delivery-web-select-xf.png)
...
![een live kopie maken](./images/delivery-web-create-lc.png)
...
![selecteer het doel](./images/delivery-web-lc-destination.png)

- Aangezien wij niet diep in de Manager van de MultiPlaats gaan, kunt u enkel deze configuratie overnemen.\
   Titel: Winkelen\
   Naam: winkel\
   Uitrolconfiguratie: Standaardconfiguratie voor rollout\
   Zodra u het levende exemplaar hebt gevormd, klik de Create knoop.

![de live kopie configureren](./images/delivery-web-lc-config.png)

>[!NOTE]
>
> Vreemd voor meer informatie over live kopieën? Uitchecken [&quot;Actieve kopieën maken en synchroniseren&quot;.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/reusing-content/msm/creating-live-copies.html?lang=en)
...
![een productpagina maken](./images/delivery-web-create-pdp.png)
...
![de sjabloon voor de productpagina gebruiken](./images/delivery-web-create-pdp-template.png)
...
![de configuratie voltooien](./images/delivery-web-pdp-initial.png)

- Eerst voegen we ons ervaringsfragment toe dat we eerder hebben gemaakt. Vervolgens kunnen we extra inhoud toevoegen die we nog steeds op de pagina willen. Tot slot zullen wij de component van productdetails vormen om ons product van Adobe te tonen door de productzoeker in de configuratiedialoog te selecteren dan onze categorie van Adobe te selecteren en de doos naast het product te controleren. Klik vervolgens op de knop Toevoegen.

![de zoeker van het product selecteren](./images/delivery-web-configure-product.png)
