...
Leer hoe het door:sturen van gebeurtenissen gegevensinzameling centraliseert, de hoeveelheid code vermindert die in uw Web en mobiele apps wordt vereist, en stroomgegevens aan niet-Adobe oplossingen via de Edge Network van Adobe Experience Platform stroomt. Voor meer informatie, gelieve de [ gebeurtenis te bezoeken die documentatie ](https://experienceleague.adobe.com/docs/experience-platform/tags/event-forwarding/overview.html) door:sturen.
