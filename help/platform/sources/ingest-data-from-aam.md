...
In deze integratievideo, leer hoe te om de gegevensschakelaar van de Audience Manager te gebruiken om eigenschappen en segmenten van AAM in het Platform te brengen en hen te combineren met andere rijke gegevens. Zie voor meer informatie de [Documentatie over de Audience Manager-bronaansluiting](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/audience-manager.html).
