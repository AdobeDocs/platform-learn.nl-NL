        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="real-time-cdp-collaboration-overview.md" title="Real-Time CDP Collaboration - Overzicht" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/exl-cards/tutorial.png" alt="Real-Time CDP Collaboration - Overzicht"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="real-time-cdp-collaboration-overview.md" target="_blank" rel="referrer" title="Real-Time CDP Collaboration - Overzicht"> het Overzicht van Real-Time CDP Collaboration </a>
                    </p>
                    <p class="is-size-6">Ontvang een inleiding aan Adobe Real-Time Collaboration, een speciaal gebouwde toepassing van de gegevenssamenwerking die u high-value publiek laat ontdekken en activeren en meetmogelijkheden gebruikt om tastbare resultaten te drijven.</p>
                </div>
