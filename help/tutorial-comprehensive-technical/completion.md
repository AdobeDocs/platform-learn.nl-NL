...
Het verwachte bewijs van voltooiing voor module **Real-Time CDP: Audience Activation aan de Hub van de Gebeurtenis van Microsoft Azure** is identiteitskaart van uw **3} bestemming van de Hub van de Gebeurtenis van Microsoft Azure {in Adobe Experience Platform.**
...
Het verwachte bewijs van voltooiing voor module **Customer Journey Analytics: Ontvang en analyseer Googles Analytics gegevens in Adobe Experience Platform met de Schakelaar van BigQuery Source** is identiteitskaart van uw **BigQuery** - bronverbinding.
