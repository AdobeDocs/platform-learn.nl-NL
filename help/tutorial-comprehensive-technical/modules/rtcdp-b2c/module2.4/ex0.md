...
# 2.4.0 Uw omgeving configureren

## 2.4.0.1 Een Azure-abonnement maken
...
![ 03-azure-gelogd-in.png ](./images/03-azure-logged-in.png)
...
## 2.4.0.2 Installeer Visual Code Studio
...
## 2.4.0.3 Visual Code-extensies installeren
...
![ 07-azure-code-uitbreiding-install.png ](./images/07-azure-code-extension-install.png)
...
## 2.4.0.6 NPM-pakket installeren: verzoek
...
Volgende Stap: [ 2.4.1 vormt uw milieu van Microsoft Azure EventHub ](./ex1.md)
