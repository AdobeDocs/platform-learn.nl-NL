...
Om een beter begrip over Offer decisioning te krijgen, adviseren wij hoogst u om het [ overzicht ](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started-decision/starting-offer-decisioning.html?lang=en) te lezen over hoe de Dienst van de Toepassing van de Offer decisioning met Adobe Experience Platform werkt.
