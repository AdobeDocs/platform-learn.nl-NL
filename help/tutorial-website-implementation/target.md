...
De Adobe Target-extensie ondersteunt client-side implementaties met behulp van de JavaScript-bibliotheek at.js van Target. Voor de implementaties van SDK van het Web van Adobe Target, zie de [ Zelfstudie van SDK van het Web van Experience Platform ](https://experienceleague.adobe.com/en/docs/platform-learn/implement-web-sdk/applications-setup/setup-target).
