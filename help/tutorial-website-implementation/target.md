...
De parameters van de entiteit zijn speciale parameters die in [ Recommendations implementaties ](https://experienceleague.adobe.com/docs/target/using/recommendations/plan-implement.html?lang=nl-NL) om drie belangrijke redenen worden gebruikt:
