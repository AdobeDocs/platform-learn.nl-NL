...
Dit zijn de enige omgevingen die we nodig hebben om de zelfstudie te voltooien. Met omgevingen kunt u verschillende werkversies van uw tagbibliotheken gebruiken die op verschillende URL&#39;s worden gehost, zodat u veilig nieuwe functies kunt toevoegen en deze op het juiste moment beschikbaar kunt stellen aan de juiste gebruikers (zoals ontwikkelaars, QA-technici, het publiek, enz.).
