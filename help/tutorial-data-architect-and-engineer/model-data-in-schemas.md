...
1. Voer **[!UICONTROL Field Name]** in als de `systemIdentifier` .
1. Voer **[!UICONTROL Display Name]** in als de `System Identifier` .
...
| Veldgroepen | AEP Web SDK ExperienceEvent |
| Veldgroepen | Consumentenervaringsgebeurtenis |
