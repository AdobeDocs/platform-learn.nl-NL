...
Toegangsbeheer is een sleutelfunctie op het gebied van privacy in Experience Platform en we raden u aan de machtigingen te beperken tot het minimum dat vereist is voor het uitvoeren van hun functies. Zie de [ documentatie van het Toegangsbeheer ](https://experienceleague.adobe.com/docs/experience-platform/access-control/home.html) voor meer informatie.
