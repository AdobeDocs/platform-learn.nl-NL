...
**&#x200B;**&#x200B;de Architecten van Gegevens 0&rbrace; &lbrace;kunnen deze les _overslaan en naar de_ partij ingesliples [&#x200B; gaan.](ingest-batch-data.md)
...
1. Voer `$request.query.challenge$` in als de hoofdtekst van de reactie. De Adobe I/O Events-meldingen die we later in deze les hebben ingesteld, vormen een uitdaging voor de webhaak en moeten worden opgenomen in de responsinstantie.
...
* [&#x200B; Begonnen het worden met de documentatie van Adobe I/O Events &#x200B;](https://www.adobe.io/apis/experienceplatform/events/docs.html)
