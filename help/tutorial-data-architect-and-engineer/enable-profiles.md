...
### Krijg meta :altId van het schema
...
1. Je moet 200 reacties krijgen
   ...
   ![&#x200B; laat het schema van CRM voor profiel met uw douanemeta :altIid toe die als param SCHEMA_ID &#x200B;](assets/profile-crm-enableProfile.png) wordt gebruikt
...
**&#x200B;**&#x200B;de Architecten van Gegevens 0&rbrace; &lbrace;kunnen vooruit _overslaan en naar de_ partij ingesliples [&#x200B; gaan.](ingest-batch-data.md)
