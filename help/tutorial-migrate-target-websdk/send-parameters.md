...
>[!NOTE]
>
>Omdat aangepaste mbox-parameters deel uitmaken van `xdm` -object, moet u alle soorten publiek-, activiteiten- of profielscripts die naar deze mbox-parameters verwijzen, bijwerken met hun nieuwe naam. Zie het [&#x200B; publiek van het Doel van de Update en profielmanuscripten voor de verenigbaarheid &#x200B;](update-audiences.md) pagina van SDK van het Web van het Platform van dit leerprogramma voor meer informatie.
