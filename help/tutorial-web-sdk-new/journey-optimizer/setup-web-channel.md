...
* Zorg ervoor dat uw AEP Web SDK-versie 2.16 of hoger is.
...
1. Controleer de **Adobe Journey Optimizer** doos.

   ![Vak AJO controleren](../assets/web-channel-check-ajo-box.png)

1. Selecteren **Opslaan**.

Dit zorgt ervoor dat binnenkomende gebeurtenissen voor de Journey Optimizer correct worden afgehandeld door de Adobe Experience Platform Edge.

## Het samenvoegbeleid configureren

Zorg ervoor dat er een samenvoegbeleid is gedefinieerd met de **Samenvoegingsbeleid actief op rand** optie ingeschakeld. Deze optie van het fusiebeleid wordt gebruikt door de inkomende kanalen van Journey Optimizer om de nauwkeurige activering en de publicatie van binnenkomende campagnes op de rand te verzekeren.

De optie configureren in het samenvoegbeleid:

1. Ga naar de **Klant > Profielen** interface.
1. Selecteer binnen de navigatie de optie **Beleid samenvoegen**.
1. Selecteer uw beleid en schakel de optie **Samenvoegingsbeleid actief op rand** in de **Configureren** stap.
...
Als u inhoudstests wilt gebruiken in webkanaalcampagnes, moet u ervoor zorgen dat de gebruikte webdataset ook wordt opgenomen in uw rapportconfiguratie. Het Journey Optimizer-rapportagesysteem gebruikt de gegevensset op een alleen-lezen manier om rapporten over het experimenteren met OTB-inhoud te vullen.
...
>[!NOTE]
>
>Aangezien deze zelfstudie op implementatoren is gericht, is het opmerkelijk dat deze les wezenlijk werk UI in AJO impliceert. Terwijl dergelijke taken UI typisch door marketers worden behandeld, kan het voor uitvoerders nuttig zijn om inzicht in het proces te krijgen, zelfs als zij niet verantwoordelijk voor de verwezenlijking van de Webkanaalcampagne aan het eind zijn.
...
1. Ga naar Reisbeheer > Campagnes in de linkernavigatie
1. Klikken **Campagne maken** rechtsboven.
1. In de **Eigenschappen** , geeft u op hoe u de campagne wilt uitvoeren. Kies voor de Gebruikszaak Loyalty Rewards **Gepland**.

   ![Geplande campagne](../assets/web-channel-campaign-properties-scheduled.png)

1. In de **Handelingen** in, kiest u **Webkanaal**. In dit stadium, kies ook de oppervlakte van het Web.
...
Kies de optie **Pagina-URL** Optie voor het web om de ervaring voor deze campagne op één pagina te implementeren. Voer de URL in voor de pagina Luma.

1. Als het weboppervlak is gedefinieerd, selecteert u **Maken**.

   ![Weboppervlak selecteren](../assets/web-channel-web-surface.png)

1. Voeg nu enkele aanvullende details toe aan de nieuwe webkanaalcampagne. Geef eerst de naam van de campagne. Roep het aan &#39;*Luma Loyalty Rewards - Gold Status - oktober 2023*&quot;. U kunt desgewenst een beschrijving aan de campagne toevoegen. Ook toevoegen **Tags** verbetering van de algemene campagnetaxonomie.

   ![Geef de campagne een naam](../assets/web-channel-campaign-name.png)

1. Standaard is de campagne actief voor alle sitebezoekers. Voor de toepassing van dit gebruiksgeval mogen alleen leden met een goudstatus de ervaring zien. Klik op **Doelgroep selecteren** en kies de &quot;*Luma Loyalty&#39;s - Gouden status* publiek.

1. In de **Naamruimte identiteit** veld, selecteert u de naamruimte voor het identificeren van personen binnen het gekozen segment. Aangezien u de campagne op de plaats van de Luma opstelt, kunt u ECID namespace kiezen. Profielen in de map &#39;*Luma Loyalty&#39;s - Gouden status*&#39; publiek dat de ECID-naamruimte niet in zijn verschillende identiteiten heeft, wordt niet aangevallen door de campagne voor webkanalen.

   ![Type identiteit kiezen](../assets/web-channel-indentity-type.png)

1. Plan de campagne die op 1 december moet beginnen met **Start campagne** en eindigt op 31 december met de **Einde campagne** -optie.

   ![Campagne](../assets/web-channel-campaign-schedule.png)

>[!NOTE]
>
>Houd er rekening mee dat voor webkanaalcampagnes de webervaring wordt weergegeven wanneer de bezoeker de pagina opent. In tegenstelling tot andere soorten campagnes in Adobe Journey Optimizer **Handelingtriggers** kan niet worden geconfigureerd.

### Experimenteer met Loyalty Rewards-inhoud

In de **Handeling** kunt u desgewenst een experiment maken om te testen welke inhoud het beste werkt voor de &#39;*Luma Loyalty&#39;s - Gouden status* publiek. Laten we twee behandelingen maken en testen als onderdeel van de configuratie van de campagne.

U kunt als volgt het inhoudexperiment maken:

1. Klikken **Experimenteren maken**.

   ![Experimenteren maken](../assets/web-channel-create-content-experiment.png)

1. Kies eerst een **Metrisch met succes**. Dit is de maatstaf voor het bepalen van de doeltreffendheid van inhoud. Kies **Unieke binnenkomende klikken**, om te zien welke inhoudsbehandeling meer kliks op het Web Ervaring CTA produceert.

   ![Kies succesmetrisch](../assets/web-channel-content-experiment-metric.png)

1. Als u een experiment instelt met gebruik van een webkanaal en de optie **Binnenkomende klikken**, **Unieke binnenkomende klikken**, **Paginaweergaven**, of **Unieke paginaweergaven** de **Handeling klikken** kunt u klikken en weergaven op specifieke pagina&#39;s nauwkeurig bijhouden en controleren.

1. U kunt desgewenst een **Holdout** die geen van beide behandelingen krijgt. Laat dit nu ongecontroleerd.

1. Kies desgewenst ook **Gelijkmatig verdelen**. Schakel deze optie in om ervoor te zorgen dat de splitsingen van de behandeling altijd gelijkmatig zijn verdeeld.
...
Laten we nu de webkanaalervaring ontwerpen. Gebruik hiervoor de Adobe Experience Cloud **Visuele hulp**. Dit gereedschap is een browserextensie die compatibel is met Google Chrome en Microsoft® Edge. Zorg ervoor dat u de extensie hebt gedownload voordat u uw ervaringen ontwikkelt. Zorg er ook voor dat de webpagina de Web SDK bevat.

1. Binnen de **Handeling** tabblad van de campagne, klikt u op **Inhoud bewerken**. Aangezien u één pagina-URL hebt ingevoerd als het oppervlak, kunt u beter beginnen te werken in de composer.

   ![Content bewerken](../assets/web-channel-edit-content.png)

1. Klik nu op **Webpagina bewerken** om te beginnen met ontwerpen.
...
1. Voeg ook verpersoonlijking aan de container toe gebruikend **Expression-editor**.

   ![Aanpassing toevoegen](../assets/web-channel-add-basic-personalization.png)

1. Zorg ervoor dat de ervaring correct voor kliks wordt gevolgd. Kies **Klikken op trackelement** in het contextmenu.

   ![Klikken op track](../assets/web-channel-click-tracking.png)

1. Gebruik de **Aanbiedingsbeslissingscomponent** om voorstellen in te voegen in de webpagina. Deze component gebruikt **Beslissingsbeheer** om de beste aanbieding te kiezen voor Luma-bezoekers.
...
Gebruik de **Componenten** om HTML of andere inhoud rechtstreeks toe te voegen aan de Luma-site.

![Het deelvenster Componenten verkennen](../assets/web-channel-components-pane.png)

Voeg een nieuwe HTML-component toe boven aan de pagina. Bewerk de HTML binnen de component vanuit de ontwerpinterface of **Contextueel** venster.

![Aangepaste HTML toevoegen](../assets/web-channel-add-html-component.png)

U kunt ook HTML-bewerkingen toevoegen vanuit de **Wijzigingen** venster. In dit deelvenster kunt u een component op de pagina selecteren en deze bewerken vanuit de ontwerpinterface.

Voeg in de editor de HTML voor de &#39;*Luma Loyalty&#39;s - Gouden status* publiek. Klikken **Valideren**.
...
Een specifieke component bewerken met de opdracht **CSS-selectietype** wijziging.
...
De mogelijkheden om de **Visuele hulp**.
...
1. Selecteren **Inhoud simuleren** in de campagne.

   ![Inhoud simuleren](../assets/web-channel-simulate-content.png)

1. Kies een testprofiel om de simulatie te ontvangen. Houd er rekening mee dat het testprofiel zich in de map &quot;*Luma Loyalty&#39;s - Gouden status*&quot;publiek om de juiste behandeling te krijgen.
...
1. U wordt gevraagd de details van de campagne een laatste keer te bevestigen. Selecteren **Activeren**. Het kan tot 15 minuten duren voordat de campagne live gaat op de site.

### Loyalty Rewards QA

Als beste praktijken, controleer **Web** tabblad van de live campagne en algemene rapporten voor de campagnespecifieke KPI&#39;s. Voor deze campagne bekijkt u de indruk dat u afbeeldingen ervaart en klikt u op Snelheid.
...
1. Open tijdens de webpagina de **Adobe Experience Platform debugger**.
   <!--
    ![ADD SCREENSHOT](#)
    -->
1. Navigeren naar **Samenvatting**. Controleer of de **DataStream-id** komt overeen met de **datastream** in **Gegevensverzameling Adoben** waarvoor je Adobe Journey Optimizer hebt ingeschakeld.
   <!--
    ![ADD SCREENSHOT](#)
    -->
...
1. Binnen de **Configuratie** tab, in-/uitschakelen **Foutopsporing inschakelen**. Hiermee kunt u zich aanmelden voor de sessie in een **Adobe Experience Platform Assurance** sessie.
   <!--
    ![ADD SCREENSHOT](#)
    -->
1. Meld u met verschillende Luma-loyaliteitsaccounts aan bij de site en gebruik foutopsporing om de aanvragen te valideren die naar de site worden verzonden **Adobe Experience Platform Edge-netwerk**. Al deze verzoeken moeten worden vastgelegd in **Betrouwbaarheid** voor het bijhouden van logbestanden.
<!--
   ![ADD SCREENSHOT](#)
-->