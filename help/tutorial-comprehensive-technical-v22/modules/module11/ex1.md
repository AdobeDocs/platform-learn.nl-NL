...
## 11.1.1 Wat is Customer Journey Analytics?
...
## 11.1.2 Belangrijkste voordelen
...
## 11.1.3 Waarom kiest u Customer Journey Analytics?
...
## 11.1.4 Begrijp de Customer Journey Analytics-workflow
...
## 11.1.5 Stap 0: Adobe Experience Platform-schema&#39;s en gegevenssets
...
U kunt de id&#39;s vinden door een schema te openen en het object te bekijken `--aepTenantId--.identification.core`. Bekijk het schema [Demosysteem - Gebeurtenisschema voor website (Global v1.1)](https://experience.adobe.com/platform/schema).
...
Volgende stap: [11.2 Connect Adobe Experience Platform-gegevenssets in Customer Journey Analytics](./ex2.md)
